# A Create-react-app with a Node server deployable to Heroku (removed hooks that are in original repo)
...
## Description of Template (written by https://github.com/mars/heroku-cra-node)
